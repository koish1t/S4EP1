...
public class SaveState
{
  ...
  public static void _saveFile(object o)
  {
    ...
    using (IsolatedStorageFileStream file = AppMain.store.CreateFile("laststate.dat"))
  ...
  public static bool isSaveAvailable()
  {
    ...
    try
    {
      return AppMain.store.FileExists("laststate.dat");
    }
    catch (Exception ex)
    {
      return false;
  ...
  public static bool loadState()
  {
    ...
    try
    {
      if (!AppMain.store.FileExists("laststate.dat"))
        return false;
      using (IsolatedStorageFileStream storageFileStream = new IsolatedStorageFileStream("laststate.dat", FileMode.Open, FileAccess.Read, AppMain.store))
  ...
  public static bool resumePlayer_2(AppMain.GMS_PLAYER_WORK ply_work)
  {
    ...
    if ((16384 /*0x4000*/ & (int) SaveState.save.player_flag) != 0)
    {
      ply_work1.obj_work.user_timer = 249856 /*0x03D000*/;
  ...
  public static bool shouldResume() => SaveState.beginResume;
  ...
  public static void showResumeWarning()
  {
    ...
    buttons.Add(Strings.ID_YES);
    buttons.Add(Strings.ID_NO);
