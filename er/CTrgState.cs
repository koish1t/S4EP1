...
public class CTrgState
{
  ...
  private static int[] takeover = new int[4]
  {
    14,
    15,
    16 /*0x10*/,
  ...
  public virtual void Push(bool is_on, bool is_edge) => this.Push(is_on, is_edge, new IntPair());
  ...
  public bool this[int kind] => this.m_state[0][kind];

  public void AddLock() => this.m_state[0].set(14, true);

  public void DelLock() => this.m_state[0].set(14, false);
  ...
  public IntPair GetRepeatInterval() => this.m_repeat_interval;

  public int GetDoubleClickTime() => this.m_wc_time;

  public int GetMoveThreshold() => this.m_move_threshold;

  public IntPair GetMove() => this.m_state[0][9] ? this.GetLastMove() : new IntPair();

  public IntPair GetLastMove() => this.m_move_report;

  public IntPair GetOver() => this.m_state[0][12] ? this.GetLastOver() : new IntPair();

  public IntPair GetLastOver() => this.m_move_report;
  ...
  public void SetRepeatInterval() => this.SetRepeatInterval(CTrgState.c_repeat_interval_default);

  public void SetDoubleClickTime(int wc_time) => this.m_wc_time = wc_time;

  public void SetDoubleClickTime() => this.SetDoubleClickTime(6);

  public void SetMoveThreshold(int move_threshold) => this.m_move_threshold = move_threshold;

  public void SetMoveThreshold() => this.SetMoveThreshold(2);
  ...
  private void updateOnPrev(bool is_on)
  {
    ...
    if (at2.test(10))
    {
      at1.set(16 /*0x10*/, at2.test(16 /*0x10*/));
    }
    else
    {
  ...
  private void updateClick()
  {
    ...
    else
    {
      if (at.test(0))
        return;
      if (at.test(16 /*0x10*/) && this.m_counter == 0)
      {
        at.set(5, true);
        at.set(16 /*0x10*/, false);
      }
  ...
  public class EState
  {
    ...
    public const int DoubleClickWait = 16 /*0x10*/;
  ...
  public class CBitset
  {
    ...
    public int Count => this.imp.Count;
    ...
    public bool test(int pos) => this.imp.Get(pos);

    public void reset() => this.imp.SetAll(false);
  }
}
