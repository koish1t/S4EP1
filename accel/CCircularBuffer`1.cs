...
public class CCircularBuffer<T> where T : new()
{
  ...
  public T getAt(int index) => this.m_data[this.indexAt(index)];

  public void setAt(int index, T value) => this.m_data[this.indexAt(index)] = value;

  public T front
  {
    get => this.getAt(0);
    set => this.setAt(0, value);
  }

  public T back
  {
    get => this.getAt(this.m_size - 1);
    set => this.setAt(this.m_size - 1, value);
  }
  ...
  public void push_front() => this.push_front(new T());
  ...
  public int max_size() => this.static_size;

  public void clear() => this.m_size = 0;

  public bool empty() => this.m_size == 0;

  public bool full() => this.static_size == this.m_size;
