...
public class SpriteObject : GameObjectBase
{
  ...
  public virtual Rectangle BoundingBox
  {
    get
    {
      Vector2 vector2 = !this.SourceRect.IsEmpty ? new Vector2((float) this.SourceRect.Width, (float) this.SourceRect.Height) : new Vector2((float) this.SpriteTexture.Width, (float) this.SpriteTexture.Height);
      Rectangle boundingBox = new Rectangle((int) this.PositionX, (int) this.PositionY, (int) ((double) vector2.X * (double) this.ScaleX), (int) ((double) vector2.Y * (double) this.ScaleY));
      boundingBox.Offset((int) (-(double) this.OriginX * (double) this.ScaleX), (int) (-(double) this.OriginY * (double) this.ScaleY));
      return boundingBox;
    }
  }
