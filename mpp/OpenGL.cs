...
{
  private const int MinBufferSize = 32 /*0x20*/;
  private const int MAX_PALETTE_MATRICES_OES = 32 /*0x20*/;
  ...
  public const ushort GL_CW = 2304 /*0x0900*/;
  ...
  public const ushort GL_NEVER = 512 /*0x0200*/;
  ...
  public const ushort GL_LIGHT0 = 16384 /*0x4000*/;
  ...
  public const ushort GL_CLIP_PLANE0 = 12288 /*0x3000*/;
  ...
  public const ushort GL_ACCUM = 256 /*0x0100*/;
  ...
  public const ushort GL_SRC_COLOR = 768 /*0x0300*/;
  ...
  public const ushort GL_2D = 1536 /*0x0600*/;
  ...
  public const ushort GL_PASS_THROUGH_TOKEN = 1792 /*0x0700*/;
  ...
  public const ushort GL_EXP = 2048 /*0x0800*/;
  ...
  public const ushort GL_FRONT_LEFT = 1024 /*0x0400*/;
  ...
  public const ushort GL_AUX_BUFFERS = 3072 /*0x0C00*/;
  ...
  public const ushort GL_CURRENT_COLOR = 2816 /*0x0B00*/;
  ...
  public const ushort GL_COEFF = 2560 /*0x0A00*/;
  ...
  public const ushort GL_PACK_SWAP_BYTES = 3328 /*0x0D00*/;
  ...
  public const ushort GL_TEXTURE_WIDTH = 4096 /*0x1000*/;
  ...
  public const ushort GL_S = 8192 /*0x2000*/;
  ...
  public const ushort GL_INVALID_ENUM = 1280 /*0x0500*/;
  ...
  public const int GL_POLYGON_STIPPLE_BIT = 16 /*0x10*/;
  public const int GL_PIXEL_MODE_BIT = 32 /*0x20*/;
  public const int GL_LIGHTING_BIT = 64 /*0x40*/;
  public const int GL_FOG_BIT = 128 /*0x80*/;
  public const int GL_DEPTH_BUFFER_BIT = 256 /*0x0100*/;
  public const int GL_ACCUM_BUFFER_BIT = 512 /*0x0200*/;
  public const int GL_STENCIL_BUFFER_BIT = 1024 /*0x0400*/;
  public const int GL_VIEWPORT_BIT = 2048 /*0x0800*/;
  public const int GL_TRANSFORM_BIT = 4096 /*0x1000*/;
  public const int GL_ENABLE_BIT = 8192 /*0x2000*/;
  public const int GL_COLOR_BUFFER_BIT = 16384 /*0x4000*/;
  public const int GL_HINT_BIT = 32768 /*0x8000*/;
  public const int GL_EVAL_BIT = 65536 /*0x010000*/;
  public const int GL_LIST_BIT = 131072 /*0x020000*/;
  public const int GL_TEXTURE_BIT = 262144 /*0x040000*/;
  public const int GL_SCISSOR_BIT = 524288 /*0x080000*/;
  public const int GL_ALL_ATTRIB_BITS = 1048575 /*0x0FFFFF*/;
  ...
  public const uint GL_ALL_CLIENT_ATTRIB_BITS = 4294967295 /*0xFFFFFFFF*/;
  public const uint GL_CLIENT_ALL_ATTRIB_BITS = 4294967295 /*0xFFFFFFFF*/;
  ...
  public const uint GL_MULTISAMPLE_BIT = 536870912 /*0x20000000*/;
  ...
  private static OpenGL.DrawArraysCallContext[] drawArraysCalls = new OpenGL.DrawArraysCallContext[256 /*0x0100*/];
  private static OpenGL.VertexPosTexColNorm[] pendingVertices = new OpenGL.VertexPosTexColNorm[4096 /*0x1000*/];
  ...
  private static OpenGL.VertexPosTexColNorm[] vtxBuffer = new OpenGL.VertexPosTexColNorm[4096 /*0x1000*/];
  ...
  private static OpenGL.TextureUnit[] m_textureUnits = new OpenGL.TextureUnit[2]
  {
  ...
  private static Texture2D m_curTexture = (Texture2D) null;
  ...
  private static OpenGL.GLVertexData m_normalArray = (OpenGL.GLVertexData) null;
  ...
  private static OpenGL.GLVertexData m_colorArray = (OpenGL.GLVertexData) null;
  ...
  private static OpenGL.GLVertexData m_vertexArray = (OpenGL.GLVertexData) null;
  ...
  private static OpenGL.GLVertexData m_weightArray = (OpenGL.GLVertexData) null;
  ...
  private static OpenGL.GLVertexData m_matrixIndexArray = (OpenGL.GLVertexData) null;
  private static bool m_secondaryColorArrayEnabled = false;
  private static readonly Matrix PROJECTION_CORRECTION = Matrix.CreateRotationZ(1.57079637f) * Matrix.CreateScale(1f, 1.12f, 0.5f) * Matrix.CreateTranslation(0.0f, 0.0f, 0.5f);
  private static OpenGL.VertexPosTexColNorm[][] m_vertices = new OpenGL.VertexPosTexColNorm[2][]
  {
    new OpenGL.VertexPosTexColNorm[32768 /*0x8000*/],
    new OpenGL.VertexPosTexColNorm[2048 /*0x0800*/]
  };
  private static short[] m_indices = (short[]) null;
  ...
  public static void glAlphaFunc(uint func, float _ref)
  {
    ...
    _ref = OpenGL.Clamp(_ref, 0.0f, 1f);
    OpenGL.m_alphaRef = (int) ((double) byte.MaxValue * (double) _ref);
  }

  public static void glArrayElement(int i) => throw new NotImplementedException();

  public static void glBegin(uint mode) => throw new NotImplementedException();
  ...
  public static void glBlendEquation(uint mode)
  {
    ...
    long key = OpenGL.CalcBlendStateId(OpenGL.m_blendState.ColorSourceBlend, OpenGL.m_blendState.AlphaSourceBlend, OpenGL.m_blendState.ColorDestinationBlend, OpenGL.m_blendState.AlphaDestinationBlend, OpenGL.m_blendState.ColorWriteChannels, ColorFunc, AlphaFunc);
    BlendState blendState;
    if (!OpenGL.m_blendStates.TryGetValue(key, out blendState))
    {
      blendState = OpenGL.m_blendState.clone();
      blendState.ColorBlendFunction = ColorFunc;
      blendState.AlphaBlendFunction = AlphaFunc;
      OpenGL.m_blendStates[key] = blendState;
    }
  ...
  public static void glBlendFunc(uint sfactor, uint dfactor)
  {
    ...
    long key = OpenGL.CalcBlendStateId(colorSrcBlend, alphaSrcBlend, colorDstBlend, alphaDstBlend, OpenGL.m_blendState.ColorWriteChannels, OpenGL.m_blendState.ColorBlendFunction, OpenGL.m_blendState.AlphaBlendFunction);
    BlendState blendState;
    if (!OpenGL.m_blendStates.TryGetValue(key, out blendState))
    {
      blendState = OpenGL.m_blendState.clone();
  ...
  public static void glBufferVertexData(OpenGL.GLVertexData data)
  {
    ...
    OpenGL.Vertex[] vertexArray = new OpenGL.Vertex[data.VertexCount];
    ...
    VertexBuffer vertexBuffer = new VertexBuffer(OpenGL.m_graphicsDevice, OpenGL.Vertex.VertexDeclaration, vertexArray.Length, BufferUsage.WriteOnly);
    vertexBuffer.SetData<OpenGL.Vertex>(vertexArray);
    ((OpenGL.VertexBufferDesc) OpenGL.m_buffers[OpenGL.m_boundArrayBuffer].buffer)?.Buffer.Dispose();
    vertexBufferDesc.Buffer = vertexBuffer;
    OpenGL.m_buffers[OpenGL.m_boundArrayBuffer].buffer = (object) vertexBufferDesc;
    OpenGL.m_buffers[OpenGL.m_boundArrayBuffer].rawData = (object) vertexArray;
  }

  public static void glBufferIndexData(OpenGL.GLIndexBuffer data)
  {
    ushort[] numArray = new ushort[data.Size];
    data.ExtractTo(numArray);
    IndexBuffer indexBuffer = new IndexBuffer(OpenGL.m_graphicsDevice, IndexElementSize.SixteenBits, data.Size, BufferUsage.None);
    indexBuffer.SetData<ushort>(numArray);
    ((GraphicsResource) OpenGL.m_buffers[OpenGL.m_boundElementArrayBuffer].buffer)?.Dispose();
    short[] dst = new short[data.Size];
    Buffer.BlockCopy((Array) numArray, 0, (Array) dst, 0, data.Size * 2);
    OpenGL.m_buffers[OpenGL.m_boundElementArrayBuffer].buffer = (object) indexBuffer;
    OpenGL.m_buffers[OpenGL.m_boundElementArrayBuffer].rawData = (object) dst;
  }
  ...
  public static void glClear(uint mask)
  {
    ...
    ClearOptions options = (ClearOptions) 0;
    if (((int) mask & 16384 /*0x4000*/) != 0)
      options |= ClearOptions.Target;
    if (((int) mask & 256 /*0x0100*/) != 0)
      options |= ClearOptions.DepthBuffer;
    if (options == (ClearOptions) 0)
      throw new ArgumentException();
    OpenGL.m_graphicsDevice.Clear(options, OpenGL.m_clearColor, OpenGL.m_clearDepth, 0);
  }

  public static void glClearColor(float red, float green, float blue, float alpha)
  {
    OpenGL.m_clearColor.R = (byte) ((double) byte.MaxValue * (double) OpenGL.Clamp(red, 0.0f, 1f));
    OpenGL.m_clearColor.G = (byte) ((double) byte.MaxValue * (double) OpenGL.Clamp(green, 0.0f, 1f));
    OpenGL.m_clearColor.B = (byte) ((double) byte.MaxValue * (double) OpenGL.Clamp(blue, 0.0f, 1f));
    OpenGL.m_clearColor.A = (byte) ((double) byte.MaxValue * (double) OpenGL.Clamp(alpha, 0.0f, 1f));
  }

  public static void glClearDepth(double depth) => OpenGL.m_clearDepth = (float) depth;

  public static void glClearDepthf(float depth)
  {
    OpenGL.m_clearDepth = OpenGL.Clamp(depth, 0.0f, 1f);
  }
  ...
  public static void glColor3fv(float[] v) => throw new NotImplementedException();

  public static void glColor4f(float red, float green, float blue, float alpha)
  {
    OpenGL.m_color.R = (byte) ((double) red * (double) byte.MaxValue);
    OpenGL.m_color.G = (byte) ((double) green * (double) byte.MaxValue);
    OpenGL.m_color.B = (byte) ((double) blue * (double) byte.MaxValue);
    OpenGL.m_color.A = (byte) ((double) alpha * (double) byte.MaxValue);
  }

  public static void glColor4fv(OpenGL.glArray4f v)
  {
    OpenGL.m_color.R = (byte) ((double) byte.MaxValue * (double) v.f0);
    OpenGL.m_color.G = (byte) ((double) byte.MaxValue * (double) v.f1);
    OpenGL.m_color.B = (byte) ((double) byte.MaxValue * (double) v.f2);
    OpenGL.m_color.A = (byte) ((double) byte.MaxValue * (double) v.f3);
  }

  public static void glColor4fv(float[] v)
  {
    OpenGL.m_color.R = (byte) ((double) byte.MaxValue * (double) v[0]);
    OpenGL.m_color.G = (byte) ((double) byte.MaxValue * (double) v[1]);
    OpenGL.m_color.B = (byte) ((double) byte.MaxValue * (double) v[2]);
    OpenGL.m_color.A = (byte) ((double) byte.MaxValue * (double) v[3]);
  }
  ...
  public static void glColorMask(byte red, byte green, byte blue, byte alpha)
  {
    ...
    long key = OpenGL.CalcBlendStateId(OpenGL.m_blendState.ColorSourceBlend, OpenGL.m_blendState.AlphaSourceBlend, OpenGL.m_blendState.ColorDestinationBlend, OpenGL.m_blendState.AlphaDestinationBlend, channels, OpenGL.m_blendState.ColorBlendFunction, OpenGL.m_blendState.AlphaBlendFunction);
    BlendState blendState;
    if (!OpenGL.m_blendStates.TryGetValue(key, out blendState))
    {
      blendState = OpenGL.m_blendState.clone();
  ...
  {
    OpenGL.m_currentPaletteMatrixOES = matrixpaletteindex < 32U /*0x20*/ ? matrixpaletteindex : throw new ArgumentException();
  }
  ...
  public static void glDeleteBuffers(int n, uint[] buffers)
  {
    ...
    {
      uint buffer = buffers[index1];
      OpenGL.BufferItem bufferItem;
      if (!OpenGL.m_buffers.TryGetValue(buffer, out bufferItem))
        throw new ArgumentException();
      if (bufferItem.buffer != null)
      {
        if (bufferItem.buffer is OpenGL.VertexBufferDesc)
          ((OpenGL.VertexBufferDesc) bufferItem.buffer).Buffer.Dispose();
        else
          ((GraphicsResource) bufferItem.buffer).Dispose();
      }
      OpenGL.m_buffers.Remove(buffer);
      uint num1 = buffer - 1U;
  ...
  public static void glDeleteTextures(int n, uint[] textures)
  {
    for (int index1 = 0; index1 < n; ++index1)
    {
      uint texture = textures[index1];
      Texture2D texture2D;
      if (!OpenGL.m_textures.TryGetValue(texture, out texture2D))
        throw new ArgumentException();
      texture2D?.Dispose();
      OpenGL.m_textures.Remove(texture);
  ...
  public static void glDepthFunc(uint func)
  {
    ...
    int key = OpenGL.CalcDepthStencilStateId(depthBufferFunction, OpenGL.m_depthStencilState.DepthBufferWriteEnable);
    DepthStencilState depthStencilState;
    if (!OpenGL.m_depthStencils.TryGetValue(key, out depthStencilState))
    {
      depthStencilState = OpenGL.m_depthStencilState.clone();
      depthStencilState.DepthBufferFunction = depthBufferFunction;
      OpenGL.m_depthStencils[key] = depthStencilState;
    }
    OpenGL.m_depthStencilState = depthStencilState;
  }

  public static void glDepthMask(byte flag) => OpenGL.glDepthMask((byte) 0 != flag);

  public static void glDepthMask(bool flag)
  {
    if (OpenGL.m_depthStencilState.DepthBufferWriteEnable == flag)
      return;
    int key = OpenGL.CalcDepthStencilStateId(OpenGL.m_depthStencilState.DepthBufferFunction, flag);
    DepthStencilState depthStencilState;
    if (!OpenGL.m_depthStencils.TryGetValue(key, out depthStencilState))
    {
      depthStencilState = OpenGL.m_depthStencilState.clone();
  ...
  private static void storeDrawArraysContext()
  {
    ...
    OpenGL.drawArraysCalls[OpenGL.drawArraysCallsCount].texture = flag ? OpenGL.m_textures[OpenGL.m_textureUnits[0].BoundTexture] : (Texture2D) null;
  ...
  {
    int index1 = 0;
    int arraysCallsCount = OpenGL.drawArraysCallsCount;
label_13:
    while (OpenGL.drawArraysCallsCount > 0)
    {
      int destinationIndex1 = 0;
      --OpenGL.drawArraysCallsCount;
      OpenGL.drawArraysCalls[index1].isPending = false;
      Array.Copy((Array) OpenGL.pendingVertices, OpenGL.drawArraysCalls[index1].vertexArrayOffset, (Array) OpenGL.drawArraysVertices, destinationIndex1, OpenGL.drawArraysCalls[index1].vertexCount);
      int destinationIndex2 = destinationIndex1 + OpenGL.drawArraysCalls[index1].vertexCount;
      for (int index2 = index1 + 1; index2 < arraysCallsCount; ++index2)
      {
        if (OpenGL.drawArraysCalls[index2].isPending)
        {
          if (OpenGL.drawArraysCalls[index1].isEqualTo(ref OpenGL.drawArraysCalls[index2]))
          {
            --OpenGL.drawArraysCallsCount;
            OpenGL.drawArraysCalls[index2].isPending = false;
            Array.Copy((Array) OpenGL.pendingVertices, OpenGL.drawArraysCalls[index2].vertexArrayOffset, (Array) OpenGL.drawArraysVertices, destinationIndex2, OpenGL.drawArraysCalls[index2].vertexCount);
            destinationIndex2 += OpenGL.drawArraysCalls[index2].vertexCount;
          }
          else if (OpenGL.drawArraysCalls[index1].blendState != OpenGL.drawArraysCalls[index2].blendState || OpenGL.drawArraysCalls[index1].depthStencilState != OpenGL.drawArraysCalls[index2].depthStencilState || OpenGL.drawArraysCalls[index2].blendState == BlendState.Opaque)
            break;
        }
      }
      OpenGL.drawPrimitives(OpenGL.drawArraysVertices, PrimitiveType.TriangleList, destinationIndex2 / 3, ref OpenGL.drawArraysCalls[index1]);
      for (; index1 < arraysCallsCount && !OpenGL.drawArraysCalls[index1].isPending; ++index1)
        OpenGL.drawArraysCalls[index1].texture = (Texture2D) null;
      while (true)
      {
        if (arraysCallsCount > index1 && !OpenGL.drawArraysCalls[arraysCallsCount - 1].isPending)
        {
          OpenGL.drawArraysCalls[arraysCallsCount - 1].texture = (Texture2D) null;
          --arraysCallsCount;
        }
        else
          goto label_13;
  ...
  public static void glDrawArrays(uint mode, int first, int count)
  {
    ...
    if (primitiveType == PrimitiveType.TriangleStrip || count > 64 /*0x40*/)
    {
      OpenGL.flushDrawArrays();
      bool twoPasses;
  ...
  public static void glDrawElements(uint mode, int count, uint type, ushort[] indices)
  {
    ...
    if (Array.IndexOf<OpenGL.GLVertexElementType>(buffer2.Components, OpenGL.GLVertexElementType.Normal) < 0)
      OpenGL.m_ambientColor = new Vector3(1f, 1f, 1f);
    VertexBuffer buffer3 = buffer2.Buffer;
    OpenGL.BufferItem buffer4 = OpenGL.m_buffers[OpenGL.m_boundElementArrayBuffer];
    bool useVB = true;
    if (OpenGL.m_textureUnits[0].TexCoordArrayEnabled && OpenGL.m_textureUnits[0].Enabled || buffer2.vertices == null)
    {
      Matrix matrix = OpenGL.m_textureUnits[0].MatrixStack.Peek();
      Matrix other = OpenGL.m_textureUnits[1].MatrixStack.Peek();
      bool flag = !buffer2.TextureMatrix.Equals(matrix);
      if (!buffer2.Texture2Matrix.Equals(other))
      {
        int num = OpenGL.m_textureUnits[1].Enabled ? 1 : 0;
      }
      if (flag || buffer2.vertices == null)
      {
        useVB = OpenGL.m_matrixPalleteOESEnabled || count > 32 /*0x20*/;
        if (buffer2.vertices == null)
        {
          buffer2.vertices = new OpenGL.Vertex[buffer3.VertexCount];
          useVB = true;
        }
        Array.Copy((Array) buffer1.rawData, (Array) buffer2.vertices, buffer3.VertexCount);
        ...
        if (useVB)
          buffer3.SetData<OpenGL.Vertex>(buffer2.vertices);
        else
    ...
    if (!useVB)
    {
      ...
      ushort[] rawData = (ushort[]) OpenGL.m_buffers[OpenGL.m_boundElementArrayBuffer].rawData;
      for (; index < count; ++index)
      {
        OpenGL.m_vertices[0][index].Position = buffer2.vertices[(int) rawData[index]].Position;
        OpenGL.m_vertices[0][index].Color = buffer2.vertices[(int) rawData[index]].Color;
        OpenGL.m_vertices[0][index].Normal = buffer2.vertices[(int) rawData[index]].Normal;
        OpenGL.m_vertices[0][index].TextureCoordinate = buffer2.vertices[(int) rawData[index]].TextureCoordinate;
      }
      OpenGL.verticesToDraw_ = count;
    ...
    {
      if (OpenGL.m_matrixPalleteOESEnabled && OpenGL.m_alphaTestEnabled && count <= 32 /*0x20*/)
        useVB = false;
      ...
      OpenGL.drawVertexBuffer(primitiveType, primitiveCount, buffer1, buffer4, useVB);
    }
  }
  ...
  private static void setupEffect(AlphaTestEffect effect)
  {
    ...
    effect.Alpha = OpenGL.m_diffuseColorAlpha;
    bool flag = OpenGL.m_textureUnits[0].TexCoordArrayEnabled && OpenGL.m_textureUnits[0].Enabled;
    effect.Texture = flag ? OpenGL.m_textures[OpenGL.m_textureUnits[0].BoundTexture] : OpenGL.m_fakeTexture;
    ...
    effect.FogEnabled = OpenGL.m_fogEnabled && (ushort) 9729 == OpenGL.m_fogMode;
  ...
  private static void setupEffect(
    ...
    ref OpenGL.DrawArraysCallContext callContext)
  {
    effect.VertexColorEnabled = callContext.vertexColorEnabled;
    effect.DiffuseColor = callContext.diffuseColor;
    effect.Alpha = callContext.diffuseColorAlpha;
    ...
    out Vector3 outNormal)
  {
    ...
    Matrix blended;
    OpenGL.blend4x3Matrix(ref bones[x], ref bones[y], ref bones[z], ref bones[w], ref blendWeights, out blended);
  ...
  private static void drawVertexBuffer(
    PrimitiveType primitiveType,
    int primitiveCount,
    OpenGL.BufferItem vbi,
    OpenGL.BufferItem ibi,
    bool useVB)
  {
    OpenGL.VertexBufferDesc buffer1 = (OpenGL.VertexBufferDesc) vbi.buffer;
    ...
    Effect effect = (Effect) OpenGL.m_basicEffect;
    if (OpenGL.m_matrixPalleteOESEnabled)
    {
      if (useVB)
      {
        ...
        effect = (Effect) OpenGL.m_skinnedEffect;
      }
      else
      {
        OpenGL.Vertex[] rawData = (OpenGL.Vertex[]) vbi.rawData;
        if (buffer1.vertices == null)
          buffer1.vertices = new OpenGL.Vertex[rawData.Length];
        for (int index = 0; index < rawData.Length; ++index)
        {
          Vector4 vector4 = rawData[index].BlendIndices.ToVector4();
          OpenGL.skinVertex(OpenGL.m_matrixPalleteOES, ref rawData[index].Position, ref rawData[index].Normal, ref vector4, ref rawData[index].BlendWeight, out buffer1.vertices[index].Position, out buffer1.vertices[index].Normal);
    ...
    if (!useVB || useVB && !OpenGL.m_matrixPalleteOESEnabled)
    {
      if (OpenGL.m_alphaTestEnabled)
      {
        ...
        effect = (Effect) OpenGL.m_alphaTestEffect;
      }
      else
    ...
    if (useVB)
    {
      ...
      foreach (EffectPass pass in effect.CurrentTechnique.Passes)
      {
        ...
        if (ibi != null)
        {
          OpenGL.m_graphicsDevice.DrawIndexedPrimitives(primitiveType, 0, 0, buffer2.VertexCount, 0, primitiveCount);
          OpenGL.m_graphicsDevice.Indices = (IndexBuffer) null;
        }
        else
          OpenGL.m_graphicsDevice.DrawPrimitives(primitiveType, 0, primitiveCount);
      }
      OpenGL.m_graphicsDevice.SetVertexBuffer((VertexBuffer) null);
    }
    else
    {
      OpenGL.Vertex[] vertices = buffer1.vertices;
      foreach (EffectPass pass in effect.CurrentTechnique.Passes)
      {
        pass.Apply();
        if (ibi != null)
        {
          ...
          OpenGL.m_graphicsDevice.DrawUserIndexedPrimitives<OpenGL.Vertex>(primitiveType, vertices, 0, vertices.Length, rawData, 0, primitiveCount);
        }
        else
  ...
  private static void _glDrawArrays_PrepareVertices(
    PrimitiveType primitiveType,
    OpenGL.VertexPosTexColNorm[] dstArray,
    int dstOffset,
    int count)
  {
    Matrix matrix1 = OpenGL.m_textureUnits[0].MatrixStack.Peek();
    ...
    Vector4 vector4 = Vector4.Transform(OpenGL.posShift, matrix2 * Matrix.Invert(OpenGL.m_modelViewMatrixStack.Peek()));
    OpenGL.VertexPosTexColNorm[] dst;
    int dstOffset1;
    if (primitiveType == PrimitiveType.TriangleStrip)
    {
      dst = OpenGL.vtxBuffer;
      dstOffset1 = 0;
    }
    else
    {
    ...
    if (OpenGL.m_textureUnits[0].Enabled && OpenGL.m_textureUnits[0].TexCoordArrayEnabled)
      OpenGL.m_textureUnits[0].TexCoordArray.ExtractTo(dst, dstOffset1, count);
    if (OpenGL.m_textureUnits[1].Enabled && OpenGL.m_textureUnits[1].TexCoordArrayEnabled)
      OpenGL.m_textureUnits[1].TexCoordArray.ExtractTo(dst, dstOffset1, count);
    ...
    for (int index1 = 0; index1 < count; ++index1)
    {
      ...
      if (OpenGL.m_textureUnits[0].Enabled && OpenGL.m_textureUnits[0].TexCoordArrayEnabled && !flag1)
    ...
    for (; index3 < count; ++index3)
    {
      ...
      dstArray[index4] = dst[index5];
      int index7 = index4 + 1;
      dstArray[index7] = dst[index6];
      int index8 = index7 + 1;
      dstArray[index8] = dst[index3];
      index4 = index8 + 1;
    }
  }
  ...
  {
    twoPasses = false;
    switch (0 | (OpenGL.m_textureUnits[0].Enabled ? 1 : 0) | (OpenGL.m_textureUnits[1].Enabled ? 2 : 0))
    {
      case 0:
        twoPasses = false;
        break;
    ...
    {
      OpenGL.m_vertices[0][index].Position.X += vector4.X;
      Vector2 result = Vector2.Zero;
      if (OpenGL.m_textureUnits[0].Enabled && OpenGL.m_textureUnits[0].TexCoordArrayEnabled && !flag)
        Vector2.Transform(ref OpenGL.m_vertices[0][index].TextureCoordinate, ref matrix1, out result);
      OpenGL.m_vertices[0][index].TextureCoordinate = result;
    }
  }
  ...
  private static void drawPrimitives(
    OpenGL.VertexPosTexColNorm[] vertices,
    PrimitiveType primitiveType,
    int primitiveCount,
    ref OpenGL.DrawArraysCallContext callContext)
  {
  ...
  public static void glEnd() => throw new NotImplementedException();

  public static void glFlush() => OpenGL.flushDrawArrays();
  ...
  public static void glGenBuffer(out uint buffer)
  {
    ...
    while (uint.MaxValue == OpenGL.m_usedBufferIDs[(IntPtr) index])
    {
      ...
      if ((long) index == (long) OpenGL.m_usedBufferIDs.Length)
        Array.Resize<uint>(ref OpenGL.m_usedBufferIDs, (int) index + 8);
    }
    uint num2 = 1;
    uint num3 = 0;
    while (num2 != 0U)
  ...
  public static void glGenBuffers(int n, uint[] buffers)
  {
    for (int index = 0; index < n; ++index)
      OpenGL.glGenBuffer(out buffers[index]);
  }
  ...
  public static void glGenTexture(out uint texture)
  {
    ...
    while (uint.MaxValue == OpenGL.m_usedTexIDs[(IntPtr) index])
    {
      ...
      if ((long) index == (long) OpenGL.m_usedTexIDs.Length)
        Array.Resize<uint>(ref OpenGL.m_usedTexIDs, (int) index + 8);
    }
    uint num2 = 1;
    uint num3 = 0;
    while (num2 != 0U)
  ...
  {
    for (int index = 0; index < n; ++index)
      OpenGL.glGenTexture(out textures[index]);
  }

  public static void glGetFloatv(uint pname, byte[] param) => throw new NotImplementedException();
  ...
  public static string glGetString(uint name) => throw new NotImplementedException();
  ...
  public static void glLoadPaletteFromModelViewMatrixOES() => throw new NotImplementedException();

  public static void glLogicOp(uint opcode) => throw new NotImplementedException();

  public static object glMapBuffer(uint target, uint access) => throw new NotImplementedException();
  ...
  public static void glNormal3fv(float[] v) => throw new NotImplementedException();
  ...
  public static void glPixelStorei(uint pname, int param) => throw new NotImplementedException();

  public static void glPolygonMode(uint face, uint mode) => throw new NotImplementedException();
  ...
  public static void glTexParameteri(uint target, uint pname, int param)
  {
    ...
    int key = OpenGL.CalcSamplerStateId(AddrU, AddrV);
  ...
  public static byte glUnmapBuffer(uint target) => throw new NotImplementedException();

  public static void glVertex3f(float x, float y, float z) => throw new NotImplementedException();

  public static void glVertex3fv(float[] v) => throw new NotImplementedException();
  ...
  static OpenGL()
  {
    ...
    OpenGL.m_matrixPalleteOES = new Matrix[32 /*0x20*/];
    for (int index = 0; index < 32 /*0x20*/; ++index)
      OpenGL.m_matrixPalleteOES[index] = Matrix.Identity;
    OpenGL.m_activeMatrixStack = OpenGL.m_modelViewMatrixStack;
  }
  ...
  public static void init(Game game, GraphicsDevice graphicsDevice)
  {
    ...
    OpenGL.m_fakeTexture.SetData<Color>(new Color[1]
    {
      new Color(1f, 1f, 1f, 1f)
    });
    OpenGL.calculateInvScreenMatrix();
    int key1 = OpenGL.CalcDepthStencilStateId(OpenGL.m_depthStencilState.DepthBufferFunction, OpenGL.m_depthStencilState.DepthBufferWriteEnable);
    OpenGL.m_depthStencils[key1] = OpenGL.m_depthStencilState;
    int key2 = OpenGL.CalcSamplerStateId(OpenGL.m_textureUnits[0].SamplerState.AddressU, OpenGL.m_textureUnits[0].SamplerState.AddressV);
    OpenGL.m_samplerStates[key2] = OpenGL.m_textureUnits[0].SamplerState;
    long key3 = OpenGL.CalcBlendStateId(OpenGL.m_blendState.ColorSourceBlend, OpenGL.m_blendState.AlphaSourceBlend, OpenGL.m_blendState.ColorDestinationBlend, OpenGL.m_blendState.AlphaDestinationBlend, OpenGL.m_blendState.ColorWriteChannels, OpenGL.m_blendState.ColorBlendFunction, OpenGL.m_blendState.AlphaBlendFunction);
    OpenGL.m_blendStates[key3] = OpenGL.m_blendState;
  }
  ...
  private static long CalcBlendStateId(
    ...
    BlendFunction AlphaFunc)
  {
    return (long) ((int) (colorSrcBlend + 1) * 32 /*0x20*/ * 32 /*0x20*/ * 32 /*0x20*/ * 32 /*0x20*/ * 32 /*0x20*/ + (int) (alphaSrcBlend + 1) * 32 /*0x20*/ * 32 /*0x20*/ * 32 /*0x20*/ * 32 /*0x20*/ + (int) (colorDstBlend + 1) * 32 /*0x20*/ * 32 /*0x20*/ * 32 /*0x20*/ + (int) (alphaDstBlend + 1) * 32 /*0x20*/ * 32 /*0x20*/ + (int) (channels + 1) * 32 /*0x20*/ + (int) (ColorFunc + 1) * 5 + AlphaFunc);
  }

  private static void calculateInvScreenMatrix()
  {
    OpenGL.m_invScreen = Matrix.Identity;
    int num1 = OpenGL.m_viewport.Width >> 1;
    int num2 = OpenGL.m_viewport.Height >> 1;
    OpenGL.m_invScreen.M11 = (float) num1;
    OpenGL.m_invScreen.M22 = (float) -num2;
    OpenGL.m_invScreen.M41 = (float) (OpenGL.m_viewport.X + num1);
  ...
  public struct Vertex : IVertexType
  {
    ...
    VertexDeclaration IVertexType.VertexDeclaration => OpenGL.Vertex.VertexDeclaration;
  }
  ...
  public struct VertexPosTexColNorm : IVertexType
  {
    ...
    VertexDeclaration IVertexType.VertexDeclaration => OpenGL.VertexPosTexColNorm.VertexDeclaration;
  }
